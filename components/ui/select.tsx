  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus-visible:border-zinc-400 focus-visible:ring-[3px] focus-visible:ring-zinc-200 dark:focus-visible:ring-zinc-700",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-50 border-zinc-200 dark:border-zinc-800",
